...
public class Jdbc {
	...
	static final String url = "jdbc:mysql:///store";
	...
	public static ResultSet searchByCustomerID(){
		 ...
		 */
		 try{
			 ...
			 statement = connect.prepareStatement("SELECT o.order_id, o.order_date_time, o.order_amount FROM orders o"
					+ " JOIN customer c WHERE c.customer_id=? AND o.order_status='shipped' ORDER BY ");
			 int custId = takeUserInputForCustomerID();
	...
	public static void insertImagesInBatch() throws SQLException{
		...
		PreparedStatement prepareStatementForImagesInsertion = connect.prepareStatement(queryForInsertion);
	...
	public static ResultSet displayCategories() throws SQLException{
		...
		PreparedStatement preparedStatementForCateogory = connect.prepareStatement(queryForCategory);
	...
	public static void deleteProduct() throws SQLException{
		...
		PreparedStatement statementForProducts = connect.prepareStatement(query);
